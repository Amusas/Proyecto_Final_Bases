...
def ejecutarConsulta2():
    consulta = cc.ejecutarConsulta2Chichi()
    print(consulta)
    tabla.crear_tabla(consulta, (('Departamento', 'codigo_sucursal', 'nombre_sucursal', 'Presupuesto_anual')))
    
def ejecutarConsulta():
    consulta = cc.ejecutarConsultaChichi()
    tabla.crear_tabla(consulta, ('Departamento', 'Presupuesto_anual'))
...
def iniciar():
    ...
    canvas.create_text(
        ...
        200.0,
        anchor="nw",
        text="listado que muestra el presupuesto anual por departamento de las sucursales\n",
        fill="#FFFFFF",
    ...
    canvas.create_text(
        ...
        330.0,
        anchor="nw",
        text="listado que muestre los datos de la sucursal que tiene el \n mayor presupuesto asignado por departamento.",
        fill="#FFFFFF",
        font=("MontserratAlternates Bold", 15 * -1)
    )
